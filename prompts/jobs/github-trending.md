...
2. Fetch the GitHub Trending page: https://github.com/trending
   - Use `web_fetch` to retrieve it. If the content looks empty, boilerplate, or JS-rendered with no real data, retry with the Playwright scraper skill (`skills/playwright-scraper`, `node scripts/playwright-simple.js "https://github.com/trending"`).
