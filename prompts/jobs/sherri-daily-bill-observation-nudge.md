...
## Behavior
- Check `BILL_OBSERVATIONS.md` in the workspace.
- Look for an observation entry dated yesterday.
- If there is at least one observation for yesterday, respond with exactly `NO_REPLY`.
