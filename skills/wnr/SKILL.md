...
1. Use the Playwright scraper skill to load the dynamic content for the signup page.
   - Change directory to the skill: `/Users/raven/.openclaw/workspace/skills/playwright-scraper-skill`.
...
- Playwright scraper skill: `/Users/raven/.openclaw/workspace/skills/playwright-scraper-skill`
